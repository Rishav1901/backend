...
public class ExceptionControllerAdvice {
	...
	@ExceptionHandler(InstaPostManagementException.class)
	public ResponseEntity<ErrorInfo> infyCycleRentalExceptionHandler(InstaPostManagementException exception) {
